...
public class ArticleApiTest {
    ...
    @Test
    void readTest() {
        ArticleResponse response = read(180674755028840448L);
        System.out.println("response = " + response);
    }
    ...
    void deleteTest() {
        restClient.delete()
                .uri("/v1/articles/{articleId}", 180674755028840448L)
                .retrieve();
    }
    ...
    @Test
    void countTest() {
        ArticleResponse response = create(new ArticleCreateRequest("hi", "content", 1L, 4L));

        Long count1 = restClient.get()
                .uri("/v1/articles/boards/{boardId}/count", 4L)
                .retrieve()
                .body(Long.class);
